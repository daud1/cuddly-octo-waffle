        ...
        return (
            <div style={{ position: 'absolute', top: 0, width: '100%', height: '100%' }} className="display-flex flex-direction-column justify-content-center center">
                <div className="angled-gradient" style={{ color: 'white', width: '30%', padding: '2em', borderRadius: '0.5em', margin: 'auto' }}>
                    ...
                    <span className="center display-block font-weight-300" style={{ fontSize: '14px', margin: '0 0 2em 0' }}>
                        I want to
                </span>
                        ...
                        <tbody>
                            <tr>
                                <td className="vertical-align-top" style={{ padding: '0 0 1em 0' }}>
                                    <span id="employer_signin-radio-btn" className={employerRadioClasses} onClick={event => this.changeAccountType(event, 'employer')}></span>
                                </td>
                                <td className="vertical-align-top" style={{ padding: '0 0 1em 0', textAlign: 'left' }}>
                                    <span className="display-block font-weight-300" style={{ fontSize: '15px', margin: '0 0 0.5em 1em' }}>
                                        Employers Account
                                </span>
                                    <span className="display-block font-weight-300" style={{ fontSize: '12px', margin: '0 0 1em 1em' }}>
                                        Consectetur adipiscing elit. Ut accumsan quam in diam porta, quis hendrerit urna eleifend.
                                </span>
                                </td>
                            </tr>
                            <tr>
                                <td className="vertical-align-top" style={{ padding: '0 0 1em 0' }}>
                                    <span id="freelancer_signin-radio-btn" className={freelancerRadioClasses} onClick={event => this.changeAccountType(event, 'freelancer')}></span>
                                </td>
                                <td className="vertical-align-top" style={{ padding: '0 0 1em 0', textAlign: 'left' }}>
                                    <span className="display-block font-weight-300" style={{ fontSize: '15px', margin: '0 0 0.5em 1em' }}>
                                        Freelancer Account
                                </span>
                                    <span className="display-block font-weight-300" style={{ fontSize: '12px', margin: '0 0 0.5em 1em' }}>
                                        Auis hendrerit urna eleifend. Cras eget velit non leo malesuada ullamcorper. Phasellus facilisis et dui
                                        id maximus.
                                </span>
                                </td>
                            </tr>
