...
class SignupForm extends Component {
  ...
  renderFormHeader = () => {
    ...
    if (user.accountType === "employer<REMOVE>") {
      return (
        <span
          ...
          <div>
            <FacebookLogin
              ...
              render={renderProps => (
                <button
                  onClick={event =>
                    handleSocialOnClick(event, setLoading, renderProps.onClick)
                  }
  ...
  signUp = event => {
    ...
    handleHTTPRequest(`${API_URL}/auth/register/`, "POST", callbacks, data);
  };
