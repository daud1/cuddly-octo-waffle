...
import talkingDogLogo from '../images/talking_dog_logo.png';
import followLogo from '../images/follow_logo.jpg';
import bubalusLogo from '../images/bubalus.png';
import elefontLogo from '../images/elefont.jpg';
import fiveTwentyLogo from '../images/five-twenty-logo.jpg';
import americanStoriesLogo from '../images/american-stories-logo.jpg';
    ...
    return (
        <div className="center word-banner light-blue-background">
            <div className="container">
                ...
                <br />
                <br />
                <span className="thin medium-paragraph float-left">Browse top jobs by member</span>
                <p />
                <table>
                    <tbody>
                        <tr>
                ...
                <br />
                <br />
                <span className="thin medium-paragraph float-left">Browse top jobs in category</span>
                <p />
                <table>
                    <tbody>
                        <tr>
