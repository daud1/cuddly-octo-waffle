...
function Footer(props) {
    ...
    const now = new Date();
    const containerStyles = isAccountSelectorPage ? { color: 'white', zIndex: 1, overflow: 'hidden' } : {};
    const containerClass = isAccountSelectorPage ? '' : 'container';
    const infoStyles = isAccountSelectorPage ? { margin: '0 3em 0 3em', overflow: 'hidden' } : {};
        ...
        <div className={containerClass} style={containerStyles} >
            ...
            <div className={infoClass} style={infoStyles}>
                ...
                <span className="profile-user-info-bold float-right">
                    <span className="profile-user-info" style={whiteFont}>LANGUAGE:</span>
            ...
            <div className={infoClass} style={infoStyles}>
                ...
                <div className="display-inline-block float-right">
                    <span className="profile-social-links" style={{ ...socialsStyles, ...whiteFont }}>
                        <i className="fa fa-facebook"></i>
                    </span>
                    <span className="profile-social-links active twitter" style={{ ...socialsStyles, ...twitterStyles }}>
