...
class Settings extends Component {
  ...
  renderSettingsPage = name => {
    ...
    if (name === "Password") {
      return (
        <div
          className="profile-info-item last"
          style={{ display: "block", padding: "0 3em 3em 0px" }}
        >
          <table>
            <tbody>
              <tr>
        ...
        >
          <table>
            <tbody>
              ...
              <tr>
                <td style={{ padding: "0 2em 0 0" }}>
                  <span className="font-weight-600 font-size-11px display-block margin-top-1em">
                    Email
                  </span>
                  <input
                    value="jonthennry@gmail.com"
                    className="full-rounded-input"
                    style={{
                      fontSize: "10px",
                      padding: "0.5em 2em",
            ...
            <tbody>
              <tr>
                <td className="vertical-align-top">
                  <span className="font-weight-600 font-size-11px display-inline-block margin-top-1em">
                    Photo
                  </span>
                </td>
                <td className="vertical-align-top">
                ...
                <td>
                  <span
                    className="btn--rounded--tiny plain grey-box-shadow font-size-11px"
                    style={{ color: "black", padding: "0.7em 2em" }}
                  >
          ...
          <span
            className="section-titles font-weight-300"
          ...
          <table style={{ margin: "0 0 3em" }}>
            <tbody>
              <tr>
                <td style={{ width: "50%" }}>
                  <span className="font-weight-600 font-size-11px display-block margin-top-1em margin-bottom-1em">
                    I want to browse the website in:
                  </span>
                  <span
                    className="wrapper-rounded-input"
                    style={{ padding: "0em 1em 0.3em" }}
                  >
                ...
                <td style={{ width: "50%" }}>
                  <span className="font-weight-600 font-size-11px display-block margin-top-1em margin-bottom-1em">
                    I want to browse the projects in the following languages:
                  </span>
                  <span
                    className="wrapper-rounded-input"
                    style={{ padding: "0em 1em 0.3em" }}
                  ...
                  <td className="profile-info-left vertical-align-top">
                    <div className="profile-info-item last">
                      <span className="section-titles font-weight-300">
                        Settings / <span className="blue">{name}</span>
                      </span>
